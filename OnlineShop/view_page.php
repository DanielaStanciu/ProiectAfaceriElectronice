...
<head>
   ...
   <title>Vizualizare rapida</title>
...
<section class="quick-view">
    ...
    <h1 class="title">Detalii produs</h1>

    <?php  
        if(isset($_GET['pid'])){
            $pid = $_GET['pid'];
            $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE id = '$pid'") or die('Interogare esuata!');
    ...
    <?php
        ...
        echo '<p class="empty">Nu exista detalii disponibile pentru acest produs!</p>';
        }
    }
    ?>

    <div class="more-btn">
        <a href="home.php" class="option-btn">Inapoi -> Acasa</a>
    </div>
