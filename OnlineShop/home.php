...
if(isset($_POST['add_to_wishlist'])){
   ...
   if(mysqli_num_rows($check_wishlist_numbers) > 0){
       $message[] = 'Produsul este deja adaugat in Wishlist!';
...
<section class="home">
   ...
   <div class="content">
      <h3>Colectii noi</h3>
      <p>Because people need flowers</p>
      <a href="about.php" class="btn">Descopera mai multe!</a>
   </div>
...
<section class="products">
   ...
   <h1 class="title">Ultimele produse</h1>

   <div class="box-container">

      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `products` LIMIT 6") or die('Interogare esuata!');
      ...
      <?php
         ...
         echo '<p class="empty">Nu au fost produse adaugate inca!</p>';
      }
      ?>
   ...
   <div class="more-btn">
      <a href="shop.php" class="option-btn">Vezi mai multe...</a>
   </div>
